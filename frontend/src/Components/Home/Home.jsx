    ...
    return (
        <div className='min-vh-100'>
            ...
            <div className='container'>
                ...
                <br />
                <div>
                    <center className='fs-4 fw-semibold' data-aos='fade-left' data-aos-delay='0' data-aos-anchor-easing='ease-in-out' data-aos-duration='200' data-aos-mirror='true'>Introduction to RoboShop</center>
                    <div className='px-2 row py-1' data-aos='fade-left' data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true'>
                        <hr />
                        ...
                        <img src={Logo} className='col-sm-12 col-md-6 col-xl-6 col-lg-6 col-xxl-6' style={{ maxHeight: '300px' }} data-aos="fade-right" data-aos-delay='150' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true' />
                    </div>
                </div>
                <br />
                <br />
                <div>
                    <center className='fs-4 fw-semibold' data-aos='fade-left' data-aos-delay='0' data-aos-anchor-easing='ease-in-out' data-aos-duration='200' data-aos-mirror='true'>RoboShop's Diverse Collection</center>
                    <div className='px-2 row py-1' data-aos='fade-left' data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true'>
                        <hr />
                        <img src={Logo} className='col-sm-12 col-md-6 col-xl-6 col-lg-6 col-xxl-6' style={{ maxHeight: '300px' }} data-aos="fade-right" data-aos-delay='150' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true' />
                ...
                <br />
                <div>
                    <center className='fs-4 fw-semibold' data-aos='fade-left' data-aos-delay='0' data-aos-anchor-easing='ease-in-out' data-aos-duration='200' data-aos-mirror='true'>User-Friendly Navigation</center>
                    <div className='px-2 row py-1' data-aos='fade-left' data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true'>
                        <hr />
                ...
                <br />
                <div>
                    <center className='fs-4 fw-semibold' data-aos='fade-left' data-aos-delay='0' data-aos-anchor-easing='ease-in-out' data-aos-duration='200' data-aos-mirror='true'>Facilitating Communication and Visits</center>
                    <div className='px-2 row py-1' data-aos='fade-left' data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true'>
                        <hr />
                        <img src={Logo} className='col-sm-12 col-md-6 col-xl-6 col-lg-6 col-xxl-6' style={{ maxHeight: '300px' }} data-aos="fade-right" data-aos-delay='150' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true' />
                ...
                <br />
                <div>
                    <center className='fs-4 fw-semibold' data-aos='fade-left' data-aos-delay='0' data-aos-anchor-easing='ease-in-out' data-aos-duration='200' data-aos-mirror='true'>Commitment to Customer Satisfaction</center>
                    <div className='px-2 row py-1' data-aos='fade-left' data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true'>
                        <hr />
                ...
                <br />
                <div>
                    <center className='fs-4 fw-semibold' data-aos='fade-left' data-aos-delay='0' data-aos-anchor-easing='ease-in-out' data-aos-duration='200' data-aos-mirror='true'>Join the RoboShop Community</center>
                    <div className='px-2 row py-1' data-aos='fade-left' data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true'>
                        <hr />
                        <img src={Logo} className='col-sm-12 col-md-6 col-xl-6 col-lg-6 col-xxl-6' style={{ maxHeight: '300px' }} data-aos="fade-right" data-aos-delay='150' data-aos-anchor-easing='ease-in-out' data-aos-duration='500' data-aos-mirror='true' />
