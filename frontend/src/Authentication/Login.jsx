...
const Login = () => {
    ...
    const HandleLogin = (e) => {
        ...
        axios.post('http://localhost:5020/login_data', { email: email, password: password })
      .then(res => {
        console.log(res)
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card bg-dark text-white" style={{borderRadius: "1rem"}}>
            <div class="card-body p-5 text-center">
              ...
              <div>
                <p class="mb-0">Don't have an account? <a href="/Registerpage" class="text-white-50 fw-bold">Sign Up</a>
                </p>
              </div>
