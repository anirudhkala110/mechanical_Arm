...
sequelize.sync({ force: false,logging: false }) // This will create the table if it doesn't exist and if exists then delete the old one and then create hance we use false in place of true so make it ture for the first run and then turn to false
    .then(() => {
        console.log('Token Tables for Robotic Arms synchronized');
    })
    .catch(error => {
